...
javascript.javascriptGenerator.forBlock['sub_block'] = function (block, generator) {
    ...
    javascript.javascriptGenerator.provideFunction_("import_server", ["import { system, world, ItemStack } from '@minecraft/server';"]);
...
Blockly.getMainWorkspace().addChangeListener(() => {
    ...
    rblockly.updatePreview(javascript.javascriptGenerator.workspaceToCode(Blockly.getMainWorkspace()));
});
